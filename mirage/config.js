...
export default function() {
  ...
  this.patch('/organizations/:slug', function(schema, request) {
    ...
    let organization = schema.organizations.findBy({
  ...
  this.get('/users/:id/organizations', (schema, request) => {
    ...
    let organizationIds = organizationUsers.models.map(
  ...
  this.get(
    '/projects/:organization_slug/:project_slug/tokens',
    (schema, request) => {
      let fullSlug = `${request.params.organization_slug}/${request.params
        .project_slug}`;
  ...
  this.get(
    '/projects/:organization_slug/:project_slug/builds',
    (schema, request) => {
      let fullSlug = `${request.params.organization_slug}/${request.params
        .project_slug}`;
      let project = schema.projects.findBy({ fullSlug: fullSlug });
